...
import { mockAgent, mockDepositRequest, mockUserData, mockWithdrawRequest } from "./helpers/libs";
  ...
  describe('AgentServie Deposit Management', () => {
    ...
    describe('approveDeposit', () => {
      ...
      it('should throw an error if the deposit request is not found', async () => {
        ...
        await expect(service.approveDeposit(id, agentId)).rejects.toThrow('Deposit request not found');
      });
  ...
  describe('AgentService - Withdrawal Management', () => {
    ...
    describe('approveWithdraw', () => {
      ...
      it('should throw an error if the withdrawal request is not found', async () => {
        ...
        await expect(service.approveWithdrawal(id, agentId)).rejects.toThrow('Withdrawal request not found');
      });
    ...
    //     await expect(service.cancelWithdrawal(id, agentId)).rejects.toThrow('Withdrawal request not found');
    //   });
